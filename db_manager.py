...
class DBManager(object):
    ...
    def __init__(self, app, db, UserClass, HostelClass, UserEmailClass=None,
    ...
    def add_user_role(self, user, role_name):
        ...
        # For others: user.roles is a list of role names
            ...
            #[Nizam] "user" is an object passed, having attribute of roles.
    ...
    def add_phone_number(self, phonenumber, **kwargs):
        phonenumber = self.UserClass(**kwargs)
        self.db_adapter.add_object(phonenumber)
        return phonenumber
    ...
    def find_hostel_by_hostelname(self):
        return self.db_adapter.find_objects(self.HostelClass)
    ...
    def save_user_details(self, user, user_email):
        """Save the User and UserEmail object."""
        if self.UserEmailClass:
            self.db_adapter.save_object(user_email)
        self.db_adapter.save_object(user)
