...
class UserManager(UserManager__Settings, UserManager__Utils, UserManager__Views):
    ...
    def __init__(self, app, db, UserClass, HostelClass, **kwargs):
        """
        Args:
        ...
        self.app = app
        if app:
            self.init_app(app, db, UserClass, HostelClass, **kwargs)

    def init_app(
        self, app, db, UserClass, HostelClass,
        ...
        #[Nizam] - Whhy this here, is this needed?
        ...
        def load_user_by_user_token(user_id):
            user = self.db_manager.UserClass.get_user_by_token(user_id)
            return user
        ...
        # --------------------
        # Setup DBManager
        self.db_manager = DBManager(app, db, UserClass, HostelClass, UserEmailClass, UserInvitationClass, RoleClass)
